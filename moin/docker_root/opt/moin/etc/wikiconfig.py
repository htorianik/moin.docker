...
class Config(multiconfig.DefaultConfig):
    ...
    instance_dir = "/opt/moin/instance"
    ...
    sitename = u'Heorhii Torianyk Wiki'
    ...
    superuser = [u"Heorhii Torianyk", u"Торяник Георгій"]
